...
* $R^2=\frac{SSE}{SST}=\frac{\sum_{i=1}^n}{(y_i-\bar{y})^2}{\sum_{i=1}^{n}{(\hat{y_i}-\bar{y})^2}}=\frac{[\sum_{i=1}^{n}{(\hat{y_i}-\bar{y})^2}]^2}{\sum_{i=1}^{n}{(y_i-\bar{y})^2}}\times \sum_{i=1}^{n}{(\hat{y_i}-\bar{y})^2}$
